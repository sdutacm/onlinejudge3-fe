...
const demoData = {
  ...
  solutionList: { "page": 1, "count": 7381684, "limit": 5, "rows": [
    { "solutionId": 8, "result": 0, "time": 0, "memory": 0, "language": "g++", "codeLength": 2333, "createdAt": 1576979088, "shared": false, "user": { "userId": 18947, "username": "bLue", "nickname": "bLue", "avatar": "5c28ecf39f2a6.jpg", "bannerImage": "5c4f1a0f0c2d9.png" }, "problem": { "problemId": 1000, "title": "A+B Problem", "timeLimit": 15000 } },
...
class Intro extends React.Component<IntroProps, IntroState> {
  ...
  renderSolutionListDemo = () => {
    const { count, page, rows } = demoData.solutionList;
